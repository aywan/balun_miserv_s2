...
func (_m *MockUser) Get(ctx context.Context, userId int64) (model.User, error) {
	ret := _m.Called(ctx, userId)
...
//   - ctx context.Context
//   - userId int64
func (_e *MockUser_Expecter) Get(ctx interface{}, userId interface{}) *MockUser_Get_Call {
	return &MockUser_Get_Call{Call: _e.mock.On("Get", ctx, userId)}
}

func (_c *MockUser_Get_Call) Run(run func(ctx context.Context, userId int64)) *MockUser_Get_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int64))
	})
	return _c
...
func (_c *MockUser_Get_Call) RunAndReturn(run func(context.Context, int64) (model.User, error)) *MockUser_Get_Call {
	_c.Call.Return(run)
	return _c
}
