...
func (c *userV1Client) Delete(ctx context.Context, in *UserIdRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (UnimplementedUserV1Server) Delete(context.Context, *UserIdRequest) (*empty.Empty, error) {
