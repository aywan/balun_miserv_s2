...
type UserV1Client interface {
	...
	Delete(ctx context.Context, in *ChatIdRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *userV1Client) Delete(ctx context.Context, in *ChatIdRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type UserV1Server interface {
	...
	// Delete chat room by Id.
	Delete(context.Context, *ChatIdRequest) (*empty.Empty, error)
	// SendMessage - publish new message in chat room,
...
func (UnimplementedUserV1Server) Delete(context.Context, *ChatIdRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Delete not implemented")
}
func (UnimplementedUserV1Server) SendMessage(context.Context, *SendMessageRequest) (*empty.Empty, error) {
